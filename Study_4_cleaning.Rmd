...
## So now we have an analytic sample of 492 (unless we also want to exclude people that took excessively long)
...
VarBase$modelrate <- names(data_noquickies)[53:90]
...
```{r new cleaned .csv}
data_reduced1 <- data_noquickies[,c(VarBase$demo, VarBase$factors, VarBase$shadiness, VarBase$manipchecks, VarBase$adsbeliefs, VarBase$consum, VarBase$modelrate, VarBase$productrate, VarBase$adrate, VarBase$conditions)]
